...
import { BRAND, SOCIAL, FOOTER_LINKS, EMAIL, PHONE_DISPLAY } from '../../data/siteConfig';
...
const SOCIAL_BUTTONS = [
  ...
  {
    name: 'Instagram', href: SOCIAL.instagram, color: '#E4405F',
  ...
  return (
    <footer ref={ref} id="contato" className="relative overflow-hidden" style={{ background: 'var(--bg-secondary)' }}>
      ...
      <div className="max-w-[1160px] mx-auto px-5 md:px-8">
        {/* Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 md:gap-14 py-16 md:py-20">
          ...
          {FOOTER_LINKS.map((col, ci) => (
            ...
            >
              <div className="flex items-center gap-2 mb-5">
                ...
                <h4 style={{ color:'var(--gold-primary)', fontSize:'0.6rem', letterSpacing:'0.2em', textTransform:'uppercase', fontWeight:600 }}>
                  {col.title}
                </h4>
              </div>
        ...
        <div style={{ borderTop:'1px solid rgba(201,168,76,0.07)', paddingTop:'22px', paddingBottom:'22px' }}>
          ...
          >
            <p style={{ fontSize:'0.68rem', color:'var(--text-muted)', letterSpacing:'0.06em' }}>
            ...
            <div className="flex items-center gap-5">
              {['Privacidade', 'Termos', 'Cookies'].map((item) => (
                <a
                  key={item}
                  href="#"
                  style={{ fontSize:'0.66rem', color:'var(--text-muted)', textDecoration:'none', letterSpacing:'0.1em', textTransform:'uppercase', transition:'color 0.2s' }}
            ...
            >
              ...
              <span style={{ fontSize:'0.58rem', color:'var(--gold-primary)', letterSpacing:'0.15em', textTransform:'uppercase' }}>
                Plataforma Premium
              </span>
            </div>
          </motion.div>
